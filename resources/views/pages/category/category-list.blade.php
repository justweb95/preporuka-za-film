  ...
  <div class="category-list-holder container">
    @if($movies && count($movies) > 0)
      ...
      <article class="movie-item">
        ...
        <svg onclick="likeButtonHandler({{ $movie->ID }})" id="{{ $movie->ID }}" class="like-button" width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$movies = new WP_Query([
  ...
  'posts_per_page' => 1,  // One post per page
  ...
  <div class="category-list-holder container">
    @if($movies->have_posts())
      ...
      <div class="pagination">
        {!! paginate_links([
          'total' => $movies->max_num_pages, // Use max_num_pages from WP_Query object
          'current' => $paged,
          'format' => '?paged=%#%',
      ...
      @php wp_reset_postdata(); @endphp  <!-- Reset post data after custom query -->

        ...
        <article class="movie-item">
          ...
          <div class="card-menu-btn-holder">
            ...
            <button class="movie-btn-already-watched">
              <svg onclick="alreadywatched({{ get_the_ID() }})" id="{{ get_the_ID() }}_watched" class="watched-button" width="26" height="24" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">

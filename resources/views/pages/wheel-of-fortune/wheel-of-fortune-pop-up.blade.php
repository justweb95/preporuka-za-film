...
<section class="wheel-of-fortune-pop-up" hidden>
  ...
  <div class="wheel-of-fortune-container">
    <h2 class="wof-pop-up-title">Dodaj željeni film</h2>
    <div class="wof-pop-up-search-box">
      <input 
        id="wheel-of-fortune-search-input"  
        class="wof-pop-up-search-input" 
        placeholder="Pretraži željeni film..." 
        type="text">
      <svg class="wof-pop-up-search-input-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

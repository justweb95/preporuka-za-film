@php
  ...
  $unseen_count = $notificationManager->getUnseenNotificationCount($user_id);
@endphp
...
<header class="tab-header">
  ...
  @if($notification)
    <div class="notification-holder">
      ...
      <button class="profile-notification {{ $unseen_count > 0 ? 'active-notification' : '' }}" id="notification_button">
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="48" height="48" rx="24" fill="#142534"/>
  ...
  @if($new_recommendations)
    <button class="new-recommendations-btn nav-link-button" data-sidebar-id="napredna_pretraga" data-tab="napredna_pretraga">

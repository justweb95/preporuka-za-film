<li>
  <article 
    id="slide<?php echo $movie_index; ?>" 
    class="single-movie-card movie-card"
    data-category="<?php echo $genres; ?>" 
    data-year="<?php echo $release_year; ?>" 
    data-rating="<?php echo $vote_average; ?>">

    <a href="<?php echo get_permalink($movie_ID); ?>">
      <img 
        src="<?php echo 'https://media.themoviedb.org/t/p/w300_and_h450_bestv2/' . $poster_path; ?>"
        alt="<?php echo get_the_title($movie_ID); ?> Poster"
        class="movie-card-poster"
        onerror="this.onerror=null; this.src='<?php echo asset('images/blog/default-blog.webp'); ?>'; this.classList.add('image-error');">
    ...
    <div class="movie-card-menu-btn-holder">
      <?php if ($our_recommendations === "true"): ?>
        <button class="movie-card-btn-our-recomentation">
          ...
          <span class="movie-card-menu-btn-tooltip">Preporučujemo</span>
        </button>
      <?php endif; ?>
